 ...
 * PUT     /api/worlds/:id          ->  upsert
 * PATCH   /api/worlds/:id          ->  patch
...
// Upserts the given World in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    delete req.body._id;
  }
  return World.findOneAndUpdate({_id: req.params.id}, req.body, {new: true, upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
